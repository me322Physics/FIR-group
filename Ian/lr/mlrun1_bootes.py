...
def get_lr(mag, q0, n_m, q_m, sigma, sigma_0_0, det_sigma, offset, center, opt_search_rad, F_of_r):
    """
...
def gen_rand_cat_inMOC(n, ra_up, ra_down, dec_up, dec_down, catmoc):
    ...
    while n!=0:
        ...
        randfieldtemp = generate_rand_pos_bootes(ra_up,dec_up,ra_down,dec_down,n)
        ...
        n = n - np.sum(randfieldtempinmoc)

    return SkyCoord(randfieldra, randfielddec, unit='deg', frame='icrs')
