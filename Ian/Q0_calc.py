...
def Q0_calc(cat1,cat2,cat1ra,cat1dec,cat2ra,cat2dec,cat2flux,ra_down,ra_up,dec_down,dec_up,radius_low,radius_up,steps,moc=None):   
    ...
    idx_radio, idx_radiox, _, _ = search_around_sky(
            coords_radio, coords_radio, 30*u.arcsec)
    
    print((idx_radio))
    
    #removes extended / multicomponet sources to find an unbiased value of Q0
    mask = []
    ...
    mask1 = radio['S_Code']=='S'
    coords_radio = coords_radio[mask & mask1]

    print(len(coords_radio))
